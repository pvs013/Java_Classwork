...
public class DrawACrate
{
    public static void main(String[] args)
    {
        ...
        face.draw();
        Line line1 = new Line(20,30,50,10);       // Top Left diag
        line1.draw();
        Line line2 = new Line(120, 70, 150, 50);      // Bottom Right diag
        line2.draw();
        Line line3 = new Line(120,30, 150, 10);   // Top Right diag
        line3.draw();
        Line line4 = new Line(50,10, 150, 10);   // Top Line
        line4.draw();
        Line line5 = new Line(150,50, 150, 10);   // Right Side
        line5.draw();
    }
}
