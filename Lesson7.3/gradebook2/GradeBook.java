...
public class GradeBook
{
    ...
    {
        double[] totaleachStudent = new double[numStudents];  //initialize array for all students
        
        for (int i=0; i < numStudents; i++)   // for each student
        {
            totaleachStudent[i] = totalForStudent(i);  // get total for student and put in array
        }
        
        return totaleachStudent;
    }
